...
InstallELFandFW=Zainstaluj aplikacjê ELF i FaultViewer
InstallELF=Zainstaluj tylko aplikacjê ELF
DescELF=Aplikacja ELF
DescFW=Aplikacja FaultViewer
FTDIinstallTxt=Za chwilê zostanie uruchomiony instalator sterownika portu komunikacyjnego USB. Podczas instalacji zostanie wyœwietlony komunikat o braku podpisu cyfrowego. Nale¿y nacisn¹æ przycisk odpowiedzialny za kontynuowanie instalacji sterownika.
AppendELF1installDirInfo=Proszê nie instalowaæ aplikacji do katalogu ze star¹ wersj¹ "ELF 1".
NewELF2projectType=Aplikacja "ELF 2" dzia³a w oparciu o nowy typ projektów. Projekty starego typu "ELF 1" zostan¹ skopiowane i przekonwertowane na nowy typ w momencie otwierania przez aplikacjê. Projekty starego typu NIE s¹ usuwane!