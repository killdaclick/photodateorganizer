...
InstallELFandFW=Установите приложение ELF и FaultViewer
InstallELF=Установка только приложение ELF
DescELF=Применение ELF
DescFW=Применение FaultViewer
FTDIinstallTxt=За короткое время будет запущена программа установки драйвера порта USB. Во время установки появится сообщение об отсутствии цифровой подписи. Нажмите ответственную кнопку за продолжение установки драйвера.
AppendELF1installDirInfo=Пожалуйста, не устанавливать приложения в каталог со старой версией "ELF-1".
NewELF2projectType=Приложение "ELF 2", работает на основани нового типа проектов. Проекты старого типа "ELF-1" будут скопированы и преобразованы в новый тип при открытии приложения. Проекты старого типа НЕ удаляются!